...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('content_type', models.ForeignKey(on_delete='CASCADE', to='role_model.ContentType')),
                ('responsibility', models.ForeignKey(on_delete='CASCADE', to='role_model.Responsibility')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='responsibility',
            name='output_type',
            field=models.ForeignKey(on_delete='CASCADE', related_name='inputs', to='role_model.ContentType'),
        ),
        migrations.AddField(
